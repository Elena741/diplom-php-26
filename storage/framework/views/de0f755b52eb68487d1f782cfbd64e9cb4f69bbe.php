...
<div class="container">
  ...
  <?php $__env->startComponent('admin.components.breadcrumb'); ?>
    <?php $__env->slot('title'); ?> Создание пользователя <?php $__env->endSlot(); ?>
    <?php $__env->slot('parent'); ?> Главная <?php $__env->endSlot(); ?>
    <?php $__env->slot('active'); ?> Пользователь <?php $__env->endSlot(); ?>
  <?php echo $__env->renderComponent(); ?>

  <hr />

  <form class="form-horizontal" action="<?php echo e(route('admin.user_managment.user.store')); ?>" method="post">
