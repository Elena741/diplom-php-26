...
<input type="text" class="form-control" name="login" placeholder="Введите login" value="<?php if(old('login')): ?><?php echo e(old('login')); ?><?php else: ?><?php echo e(isset($user->login) ? $user->login : ""); ?><?php endif; ?>" required>
